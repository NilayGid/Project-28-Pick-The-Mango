...
function setup() {
 ...
 mango4 = new mango(967, 253, 30);
 mango5 = new mango(932, 198, 30);
 mango6 = new mango(1074, 200, 30);
 //241, 1209
 //1182, 216
 //965 72
 //852  183
 mango7 = new mango(1209, 241, 30);
 mango8 = new mango(1182, 216, 30);
 mango9 = new mango(965, 72, 30);
 mango10 = new mango(852, 183, 30);
